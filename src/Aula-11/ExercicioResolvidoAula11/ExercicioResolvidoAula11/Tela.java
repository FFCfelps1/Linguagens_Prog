...
public class Tela extends JFrame implements ActionListener
{
   ...
   public void actionPerformed(ActionEvent e)
   {
		...
		if(e.getSource() == btnCalcula) 
      {
         ...
         {
				// e um cilindro
				Ponto ponto = new Ponto(Double.parseDouble(coordenadaX), Double.parseDouble(coordenadaY));
				Circulo circulo = new Circulo(ponto, Double.parseDouble(raio));
				Cilindro cilindro = new Cilindro(circulo, Double.parseDouble(altura));
