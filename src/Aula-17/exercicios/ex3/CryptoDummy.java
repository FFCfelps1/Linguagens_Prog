...
public class CryptoDummy {
    ...
    public void geraCifra(byte[] texto, File fDummy)
        ...
        {
            textoCifrado[i] = (byte) (textoCifrado[i] + i + iDummy * 2);
        }
    }

    public byte[] getTextCifrado() throws Exception {
        return textoCifrado;
    }
    ...
    public void geraDecifra(byte[] texto, File fDummy)
        ...
        for(int i = 0; i < texto.length; i++)
        {
            textoDecifrado[i] = (byte) (textoDecifrado[i] - i - iDummy * 2);
        }
    }
